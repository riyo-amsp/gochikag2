...
public class ItemDTOtest {
	...
	@Test
	public void testGetStockNumberNumber1() {
		ItemDTO test = new ItemDTO();
		int expected = 0;

		test.setStockNumber(expected);
		int actual = test.getStockNumber();

		assertEquals(expected, actual);
	}

	/**
	 * {@link com.internousdev.flowers.dto.ItemDTO#setStock()}
	 * のためのテスト・メソッド。
	 */
	@Test
	public void testGetStockNumber2() {
		ItemDTO test = new ItemDTO();
		int expected = 2147483647;
	 ...
	 */
	@Test
	public void testGetStockNumber3() {
		ItemDTO test = new ItemDTO();
		int expected = -2147483648;
	 ...
	 */
	@Test
	public void testGetStockNumber4() {
		ItemDTO test = new ItemDTO();
		try {
			int StockNumberMax = Integer.parseInt("2147483648");
			test.setStockNumber(StockNumberMax);
	 ...
	 */
	@Test
	public void testGetStockNumber5() {
		ItemDTO test = new ItemDTO();
		try {
			int StockNumberMax = Integer.parseInt("-2147483649");
			test.setStockNumber(StockNumberMax);
	...
	/**
	 * {@link com.internousdev.flowers.dto.ItemDTO#setStock(int)}
	 * のためのテスト・メソッド。
	 */
	@Test
	public void testSetStockNumber1() {
		ItemDTO test = new ItemDTO();
		int expected = 0;
	 ...
	 */
	@Test
	public void testSetStockNumber2() {
		ItemDTO test = new ItemDTO();
		int expected = 2147483647;
	 ...
	 */
	@Test
	public void testSetStockNumber3() {
		ItemDTO test = new ItemDTO();
		int expected = -2147483648;
	 ...
	 */
	@Test
	public void testSetStockNumber4() {
		ItemDTO test = new ItemDTO();
		try {
			int StockNumberMax = Integer.parseInt("2147483648");
			test.setStockNumber(StockNumberMax);
	 ...
	 */
	@Test
	public void testSetStockNumber5() {
		ItemDTO test = new ItemDTO();
		try {
			int StockNumberMax = Integer.parseInt("-2147483649");
			test.setStockNumber(StockNumberMax);
