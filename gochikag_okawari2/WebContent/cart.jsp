...
<head>
	...
	<fmt:setBundle basename="com.internousdev.gochikag.property.cart" var="lang" />
						...
						<tr>
							...
							<td class="text-center">
								<form action="CartDeleteAction">
									<input type="hidden" name="itemId" value="<s:property value="itemId" />" /> 
									<input type="submit" type="button" value="<s:text name="lang.cart.delete"/>" class="form-control"/>
								</form>
							</td>
						</tr>
					</s:iterator>
