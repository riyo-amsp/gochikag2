...
/*kagu detail*/
insert into detail values(1,'特別な食器を、飾りながら収納できます。たくさん物が置けるのでリビングで実用的に使えます。アンティークの鍵が付いています。鍵を取っ手のようにして開閉してください。','You can house special dishes into this cabinet.It is very useful because you can place a lot of things.Open and close the door by using an antique key.','0');
insert into detail values(2,'高級感あふれる雰囲気が素敵なアンティークの小さなチェストです。時計や携帯を置いたり、写真を飾ったりとディスプレイも楽しめます。','This is a small antique chest who adds a touch of class to the room. You can enjoy displaying a variety of goods (clock,pictures...etc) on the chest.','0');
insert into detail values(3,'美しいアンティークティーテーブルです。波打つような天板のカッティングやしなやかに伸びた美しい脚がポイントです。そっと壁に付けて置くだけで、オシャレな雰囲気に。玄関や廊下など狭い場所でも使えます。','This is an antique table who has beautiful designs and slender legs. If you buy this one, you can change the atmosphere in your room and also use it in narrow places. (entrance,hallway...)','0');
insert into detail values(4,'コンパクトなサイズのチェストの上に、可愛い三面鏡の付いたドレッシングチェストです。リビングや目立つところに積極的に飾って自慢したくなっちゃいます。','What a pretty dressing chest this is! You will want to show off if you place it in a living room.','0');
insert into detail values(5,'クラシカルなフレンチスタイルのソファです。大人２,３人で使えます。ミニクッションが２つ付いて、掛け心地もデザインも充実した一台です。','This is a classical french sofa with two small cushions. Thanks to this one, you will relax even if you are tired.','0');
insert into detail values(6,'女性らしい優雅なアンティークのサロンチェアです。優しいピンク色の張り地と高級感漂う芸術的な彫りの装飾・・・見ているだけで楽しめる素敵な１脚です。','What a elegant salon chair this is! Lovely pink furniture upholsteries and artistic ornaments... Umm, you can enjoy just by seeing it!','0');
...
insert into item values(9,'空気清浄器',2500,'img/item/kaden/air_clean.jpg',20,'0','2017-03-17-12:00','2017-03-17-12:00','kaden');
...
/*kaden detail*/
insert into detail values(7,'コーヒー通を唸らせる、プロのハンドドリップにも負けない本格的な仕上がり。','Let us have some good coffee by using this high-spec machine.','0');
insert into detail values(8,'コロンとしたフォルムがかわいいポップアップトースター','This is a pretty pop-up toaster.You can make toast very well.','0');
insert into detail values(9,'アンドレ空気清浄機は植物のフィルターを使う為、通常の空気清浄機で使う取替フィルターが必要ありません。その独自のフォルムとシンプルな作りからどんなお部屋でに馴染み、植物がもつ浄化能力を飛躍的に高めてくれます。また8個のLED電球がインテリアライトとしても美しくお部屋を変えてくれます。','This air cleaner has a vegetable filter instead of normal one. Thanks to this function,it is possible to improve purifying capability dramatically.Besides, eight LED bulb change the atomospere of your room.','0');
insert into detail values(10,'ふんわりやわらかいライトが照らしてくれます。','This light shine on you softly and kindly.','0');
insert into detail values(11,'電気で動く”いまどき”な暖炉です。','This is a modern fireplace running on electricity.','0');
insert into detail values(12,'スマホでは味わえないおしゃれな音楽を味わえます。','You can enjoy wonderful music with this phonograph.','0');
...
/* sale detail*/
insert into detail values(13, 'ココアやカプチーノを入れて、素敵なティータイムをどうぞ!', 'Please have a nice tea time with this teapot.', '0');
insert into detail values(14,'思わず体も心もぴょんぴょん♪してしまうそんな一品です。','This is an amazing sofa who makes you excited.','0');
insert into detail values(15,'｢ポイッ」って捨ててみてください。あっ・・・でも、今日を「ポイッ」てしないでくださいね（ダメです）','When you throw away the rubbish, put it in this trash box. Oops, but don not throw your life away.You only live once.','0');
insert into detail values(16,'ラビットハウスにもこんな時計がありそうですね。','It seems to be able to find a clock like this in a rabbit house.','0');
insert into detail values(17,'女の子の憧れをご注文しませんか？','Will you order longings of girls?','0');
insert into detail values(18,'かわいさだけを、プレンドしました。','We blended much loveliness.','0');